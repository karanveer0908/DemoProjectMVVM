...
class FollowingFragments : Fragment(R.layout.fragment_follow) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initializeViewModel(view, savedInstanceState)

    }

    private fun initializeViewModel(view: View, savedInstanceState: Bundle?) {
        val args = arguments
    ...
    private fun setAdapterAndFetchData() {
        ...
        fragmentViewModel!!.fetchListOfFollowing(mUsername)
        fragmentViewModel!!.getListofFollowings().observe(viewLifecycleOwner, {
            if (it != null) {
